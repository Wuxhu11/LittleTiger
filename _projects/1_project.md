...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/FL-framework.png" title="example image" class="img-fluid rounded z-depth-1" style="max-width: 80%;" alt="Description" %}
    </div>
</div>
<div class="caption">
